...
{                           // **Canvas_Widget** embeds a WebGL demo onto a website in place of the given placeholder document
  ...
  constructor( element, initial_scenes, options = {}, dim )   
    { this.element = element;
      ...
      this.webgl_manager = new tiny.Webgl_Manager( canvas, color( 0,0,0,1 ), dim );  // Second parameter sets background color.
